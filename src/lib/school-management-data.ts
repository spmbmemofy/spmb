...
export type SchoolJenjang = 'SMP' | 'SMA';
...
export const initialManagedSchools: ManagedSchool[] = [
  ...
  { npsn: '30401828', namaSekolah: 'SMK Negeri 1 Berau', jenjang: 'SMA', jenis: 'Negeri' },
  { npsn: '30401831', namaSekolah: 'SMA Negeri 4 Berau', jenjang: 'SMA', jenis: 'Negeri' },
];
