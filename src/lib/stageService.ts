...
const initialStages: Tahap[] = [
  { id: 'tahap-1', name: 'Tahap 1', startDate: now.toISOString(), endDate: tahap1EndDate.toISOString() },
  { id: 'tahap-2', name: 'Tahap 2', startDate: tahap2StartDate.toISOString(), endDate: tahap2EndDate.toISOString() },
];
...
export function addStage(newStage: Omit<Tahap, 'id'>): Tahap {
